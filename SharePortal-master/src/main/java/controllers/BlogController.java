...
public class BlogController {
	...
	public String createBlog(@ModelAttribute("nblg") Blog blog,Model model)throws IOException
	{
		...
		url="C:/Users/koel.chowdhury/Downloads/SharePortal-master/src/main/webapp/WEB-INF/views"+url;
		System.out.println(url);
		BufferedReader fr=new BufferedReader(new FileReader("C:/Users/koel.chowdhury/Downloads/SharePortal-master/src/main/webapp/WEB-INF/views/writeblog.jsp"));
